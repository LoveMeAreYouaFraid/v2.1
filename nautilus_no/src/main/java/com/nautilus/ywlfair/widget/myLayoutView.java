...
public class myLayoutView extends LinearLayout {
    ...
    private RippleView.OnEndClickListener mOnEndClickListener;
    ...
    public void setOnEndClickListener(int id, RippleView.OnEndClickListener listener) {
    ...
    public myLayoutView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRippleColor = a.getColor(R.styleable.RippleView_rippleColo,
                mRippleColor);
        ...
        if (event.getActionMasked() == MotionEvent.ACTION_DOWN
            ...
            mRadiusAnimator.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animator) {
                    setRadius(0);
                    ViewHelper.setAlpha(myLayoutView.this, 1);
                    mIsAnimating = false;
                }
            ...
            mRadiusAnimator.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    ViewHelper.setAlpha(myLayoutView.this, 1);
                    mIsAnimating = false;
                    mOnEndClickListener.mViewClick(viewid);
                }
