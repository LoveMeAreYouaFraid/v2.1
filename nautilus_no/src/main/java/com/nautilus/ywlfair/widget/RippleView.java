...
public class RippleView extends AppCompatTextView {
    ...
    public void setOnEndClickListener(int id, OnEndClickListener listener) {
    ...
    public boolean onTouchEvent(final MotionEvent event) {
        ...
        if (event.getActionMasked() == MotionEvent.ACTION_UP
            ...
            mRadiusAnimator = ObjectAnimator.ofFloat(this, "radius", 0, dp(0))
                    .setDuration(0);
            mRadiusAnimator
    ...
    /**
     * setRippleColor 设置动画效果颜色
     */
    public interface OnEndClickListener {

        void mViewClick(int id);
