 ...
 * 申请退押金Request
 */
public class PostReturnDepositRequest extends InterfaceRequest<InterfaceResponse> {


    private static final String TAG = PostReturnDepositRequest.class.getSimpleName();

    public PostReturnDepositRequest(String userId, String depositId, ResponseListener<InterfaceResponse> listener) {
        super(Method.POST,Constant.URL.POST_RETURN_DEPOSIT,userId,
                RequestUtil.getReturnDepositParams(depositId), listener);
    }
