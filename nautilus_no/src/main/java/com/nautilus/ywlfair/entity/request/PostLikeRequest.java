 ...
 * 设置新密码Request
 */
public class PostLikeRequest extends InterfaceRequest<PostLikeAndJoinResponse> {


    private static final String TAG = PostLikeRequest.class.getSimpleName();

    public PostLikeRequest(String itemId, int itemType, int isLike,int userId, ResponseListener<PostLikeAndJoinResponse> listener) {
        super(Method.POST,Constant.URL.POST_LIKE, "",
                RequestUtil.getLikeParams(itemId, itemType, isLike, userId), listener);
    }
