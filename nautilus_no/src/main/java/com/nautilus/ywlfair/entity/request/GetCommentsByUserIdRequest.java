 ...
 * 活动评论Request
 */
public class GetCommentsByUserIdRequest extends InterfaceRequest<GetActivityCommentsResponse> {


    private static final String TAG = GetCommentsByUserIdRequest.class.getSimpleName();

    public GetCommentsByUserIdRequest(String userId, int type, int start, int rows, ResponseListener<GetActivityCommentsResponse> listener) {
        super(Method.GET,Constant.URL.GET_COMMENTS_BY_USER_ID,userId, RequestUtil.getUserCommentParams(start, rows, type), listener);
    }
