...
import com.nautilus.ywlfair.entity.bean.Author;
 ...
 * 活动评论详情response
 */
public class GetCommentDetailResponse extends InterfaceResponse implements Serializable {
    ...
    public class MyResult implements Serializable{
        ...
        public CommentDetailInfo getCommentInfo() {
            return commentInfo;
        }

        public void setCommentInfo(CommentDetailInfo commentInfo) {
    ...
    public class CommentDetailInfo implements Serializable{
        ...
        public List<CommentInfo> getReplyCommentList() {
            return replyCommentList;
        }

        public void setReplyCommentList(List<CommentInfo> replyCommentList) {
