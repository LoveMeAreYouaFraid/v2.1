 ...
 * 发送重置密码邮件Request
 */
public class PostResetEmailRequest extends InterfaceRequest<InterfaceResponse> {


    private static final String TAG = PostResetEmailRequest.class.getSimpleName();

    public PostResetEmailRequest(String email, ResponseListener<InterfaceResponse> listener) {
        super(Method.POST,Constant.URL.POST_RESET_EMAIL,"", RequestUtil.getResetEmailParams(email), listener);
    }
