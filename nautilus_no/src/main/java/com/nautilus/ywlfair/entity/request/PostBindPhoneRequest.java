 ...
 * 绑定手机Request
 */
public class PostBindPhoneRequest extends InterfaceRequest<InterfaceResponse> {


    private static final String TAG = PostBindPhoneRequest.class.getSimpleName();

    public PostBindPhoneRequest(String userId, String phone, String code, ResponseListener<InterfaceResponse> listener) {
        super(Method.POST,Constant.URL.POST_BIND_PHONE, userId,
                RequestUtil.getBindPhoneParams(phone, code), listener);
    }
