 ...
 * 验证支付密码Request
 */
public class GetPayAuthorizationRequest extends InterfaceRequest<InterfaceResponse> {


    private static final String TAG = GetPayAuthorizationRequest.class.getSimpleName();

    public GetPayAuthorizationRequest(int userId, String password, ResponseListener<InterfaceResponse> listener) {
        super(Method.GET,Constant.URL.PAY_AUTHORIZATION,userId + "",
                RequestUtil.getPayAuthorizationParams(password), listener);
    }
