 ...
 * 活动评论Request
 */
public class PostCommentRequest extends InterfaceRequest<PostCommentResponse> {


    private static final String TAG = PostCommentRequest.class.getSimpleName();

    public PostCommentRequest(String userId, String content, String itemId,
                              String itemType, String rating, String photos, String location,
                              String coordinates, ResponseListener<PostCommentResponse> listener) {
        super(Method.POST,Constant.URL.POST_COMMENTS_BY_ACTIVITY_ID,"",
                RequestUtil.getPostCommentByActParams(userId, content,itemId,itemType,
                        rating,photos,location,coordinates), listener);
    }
