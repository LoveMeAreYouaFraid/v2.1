 ...
 * 绑定推送Tag Request
 */
public class PostBindPushTagRequest extends InterfaceRequest<InterfaceResponse> {


    private static final String TAG = PostBindPushTagRequest.class.getSimpleName();

    public PostBindPushTagRequest(int userId, String tag, ResponseListener<InterfaceResponse> listener) {
        super(Method.POST,Constant.URL.PUSH_TAG,"",
                RequestUtil.getPostPushTagParams(userId,tag), listener);
    }
