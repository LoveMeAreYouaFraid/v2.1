 ...
 * 设置新密码Request
 */
public class PostResetPasswordRequest extends InterfaceRequest<InterfaceResponse> {


    private static final String TAG = PostResetPasswordRequest.class.getSimpleName();

    public PostResetPasswordRequest(String phone,String psw, ResponseListener<InterfaceResponse> listener) {
        super(Method.POST,Constant.URL.POST_SET_NEW_PASSWORD,"",
                RequestUtil.getResetPasswordParams(phone,psw), listener);
    }
