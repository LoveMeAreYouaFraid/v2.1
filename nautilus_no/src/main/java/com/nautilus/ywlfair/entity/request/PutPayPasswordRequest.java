 ...
 * 修改支付密码状态Request
 */
public class PutPayPasswordRequest extends InterfaceRequest<InterfaceResponse> {


    private static final String TAG = PutPayPasswordRequest.class.getSimpleName();

    public PutPayPasswordRequest(String userId, String oldPassword, String newPassword, ResponseListener<InterfaceResponse> listener) {
        super(Method.PUT,Constant.URL.PAY_PASSWORD, userId,
