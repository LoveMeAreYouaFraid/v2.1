 ...
 * 可购摊位Request
 */
public class GetBoothStatusRequest extends InterfaceRequest<InterfaceResponse> {


    private static final String TAG = GetBoothStatusRequest.class.getSimpleName();

    public GetBoothStatusRequest(String userId, ResponseListener<InterfaceResponse> listener) {
        super(Method.GET,Constant.URL.GET_BOOTH_STATUS,userId, null, listener);
    }
