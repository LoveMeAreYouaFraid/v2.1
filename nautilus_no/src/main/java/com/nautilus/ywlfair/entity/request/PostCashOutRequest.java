 ...
 * 提现Request
 */
public class PostCashOutRequest extends InterfaceRequest<InterfaceResponse> {

    private static final String TAG = PostCashOutRequest.class.getSimpleName();

    public PostCashOutRequest(int userId, String amount, String password, ResponseListener<InterfaceResponse> listener) {
        super(Method.POST,Constant.URL.CASH_OUT, userId + "",
                RequestUtil.getCashOutParams(amount, password), listener);
    }
