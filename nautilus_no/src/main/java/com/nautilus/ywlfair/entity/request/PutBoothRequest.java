 ...
 * 退订摊位Request
 */
public class PutBoothRequest extends InterfaceRequest<InterfaceResponse> {


    private static final String TAG = PutBoothRequest.class.getSimpleName();

    public PutBoothRequest(String userId, String orderId, ResponseListener<InterfaceResponse> listener) {
        super(Method.PUT,Constant.URL.GET_BOOTH_DETAIL, userId,
                RequestUtil.getCancelParams(orderId), listener);
    }
