...
public class AddPictureAdapter extends BaseAdapter {
    ...
    public AddPictureAdapter(Context context, List<Uri> items) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(position == mItems.size()) {
            ...
            final Uri item = mItems.get(position);
            ...
            DisplayImageOptions options = new DisplayImageOptions.Builder()
                    ...
                    .build();
           ImageLoader.getInstance().displayImage(item.toString(), holder.pictureImageView, options);
        }
